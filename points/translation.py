...
class Naive_questionsTranslationOptions(TranslationOptions):
    fields = ('name', 'description', 'about_title', 'about_1',
              'about_2', 'details_title', 'details_1', 'we_can',
              'we_can_1_title', 'we_can_1', 'we_can_2_title',
...
@register(Art_cartel)
class Art_cartelTranslationOptions(TranslationOptions):
